    ...
    <div class="content-container">
      ...
      <el-card class="visualization-card">
        ...
        <div v-if="detectionResult">
          <img :src="'data:image/png;base64,' + detectionResult.image" alt="Processed Image" class="processed-image" />
        </div>
        <p v-else>请上传图片并进行识别以查看处理后的效果。</p> <!-- 提示信息 -->
      </el-card>
    </div>

    <!-- 一键识别按钮 -->
    <div class="button-container">
      <el-button type="primary" @click="oneClickIdentify" class="identify-button full-width">一键识别</el-button>
    </div>
